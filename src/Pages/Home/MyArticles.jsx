    ...
    <section className="articles--section" id="articles">
      <div className="project--container-box">
        <div className="project--container">
          <p className="sub--title">Writing And Sharing</p>
          <h2 className="sections--heading">My Articles</h2>
        </div>
      </div>
      <div className="project--section--container">
        {data?.articles?.map((item, index) => (
          <div key={index} className="articles--section--card">
            <div className="articles--section--card--review">
            ...
            <div className="articles--section--card--author--detail">
              <div>
                <p className="text-md articles--author--name">
                  {item.articles_title}
                </p>
                <p className="text-md articles--author--designation">
                  {item.articles_table}
                </p>
              </div>
            </div>
